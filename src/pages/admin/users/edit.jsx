...
export const EditUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = `https://intern-manage-2025-production.up.railway.app/api/users/${id}`;
    ...
    try {
      const res = await axios.post(url, formData, {
        headers: {
          Authorization: `Bearer ${Cookies.get("token")}`,
          "X-HTTP-Method-Override": "PUT", // Laravel support
        },
      });
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4 pt-4">
          <button
            ...
            } bg-blue-800 text-white px-6 py-2 rounded-lg hover:bg-blue-900 transition`}
          >
